...
public class PracticalTestMain {
    public static void main(String[] args) {
        ...
        System.out.println("Sum of plus elements in array = " + MethodsOfMas.sumPlus(mas));
        System.out.println("Count of plus elements in array = " + MethodsOfMas.countOfPlusElementInArray(mas));
