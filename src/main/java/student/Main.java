...
public class Main {
    public static void main(String[] args) throws InvalidFormatException, SQLException, IOException, JAXBException {
        ...
        IO io = new JsonIO();
        System.out.println(io.convertFromStudentToString(stud1));
        FileWriter fileWriter1 = new FileWriter("D:\\IO\\MyJson.txt");
        fileWriter1.write(io.convertFromStudentToString(stud1));
        fileWriter1.close();

        IO io1 = new XmlIO();
        System.out.println(io1.convertFromStudentToString(stud1));
        FileWriter fileWriter = new FileWriter("D:\\IO\\MyXML.txt");
        fileWriter.write(io1.convertFromStudentToString(stud1));
        fileWriter.close();
